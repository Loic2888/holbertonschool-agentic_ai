      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-12 mb-16">
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left gap-6 lg:w-1/3">
            ...
            {/* Logo et Texte */}
            <div>
              <a href="/" className="flex items-center justify-center lg:justify-start gap-3 text-slate-50 hover:opacity-80 transition-opacity mb-3">
                {/* Ton style : p-1 */}
                <div className="p-1 font-semibold rounded-lg bg-violet-500 flex items-center justify-center shadow-lg shadow-violet-500/40">
            ...
            {/* Boutons Réseaux Sociaux (Ton style : gap-2, p-2, border-slate-800) */}
            <div className="flex items-center gap-2">
              
              {/* Bouton Instagram */}
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="p-2 bg-black text-white border border-slate-800 rounded-lg hover:bg-slate-900 hover:border-slate-400 transition-all group">
              ...
              {/* Bouton TikTok */}
              <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="p-2 bg-black text-white border border-slate-800 rounded-lg hover:bg-slate-900 hover:border-slate-400 transition-all group">
              ...
              {/* Bouton X */}
              <a href="https://x.com" target="_blank" rel="noopener noreferrer" aria-label="X" className="p-2 bg-black text-white border border-slate-800 rounded-lg hover:bg-slate-900 hover:border-slate-400 transition-all group">
                <svg className="w-4 h-4 fill-slate-300 group-hover:fill-white transition-colors" viewBox="0 0 24 24">
              ...
              {/* Bouton YouTube */}
              <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="p-2 bg-black text-white border border-slate-800 rounded-lg hover:bg-slate-900 hover:border-slate-400 transition-all group">
                <svg className="w-4 h-4 fill-slate-300 group-hover:fill-white transition-colors" viewBox="0 0 24 24">
