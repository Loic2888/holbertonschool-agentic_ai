<script>
  // N'oublie pas d'ajouter l'extension .svelte !
  import Button from '../ui/Button.svelte';
  import Badge from '../ui/Badge.svelte';
</script>

<section id="hero-section" class="relative pt-36 pb-24 overflow-hidden">
  ...
  <!-- 2. LE CONTENU -->
  <div class="relative z-0 max-w-6xl mx-auto px-6 text-center">
    ...
    <!-- Titres -->
    <h1 class="text-5xl md:text-7xl font-black text-white tracking-tight leading-none mb-12">
    ...
    <div class="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
      <!-- On passe les props exactement comme en React -->
      <!-- Note: showIcon={true} peut s'écrire simplement showIcon en Svelte (et en React aussi d'ailleurs) -->
      <Button 
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
      ...
      <div class="p-6 rounded-xl border border-slate-800 text-center bg-slate-950 shadow-xl shadow-slate-950/40">
        <h3 class="text-3xl md:text-4xl font-black text-violet-300 mb-2">10K+</h3>
        <p class="text-sm text-slate-500">Active agents</p>
      </div>

      <div class="p-6 rounded-xl border border-slate-800 text-center bg-slate-950 shadow-xl shadow-slate-950/40">
        <h3 class="text-3xl md:text-4xl font-black text-violet-300 mb-2">99.9%</h3>
        <p class="text-sm text-slate-500">Uptime</p>
      </div>

      <div class="p-6 rounded-xl border border-slate-800 text-center bg-slate-950 shadow-xl shadow-slate-950/40">
        <h3 class="text-3xl md:text-4xl font-black text-violet-300 mb-2">50M+</h3>
        <p class="text-sm text-slate-500">Tasks automated</p>
      </div>

      <div class="p-6 rounded-xl border border-slate-800 text-center bg-slate-950 shadow-xl shadow-slate-950/40">
        <h3 class="text-3xl md:text-4xl font-black text-violet-300 mb-2">24/7</h3>
